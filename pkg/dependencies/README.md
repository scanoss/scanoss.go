...
The `parsers` package provides several utility functions:

### Path & URL Validation

```go
import "github.com/scanoss/scanoss.go/pkg/dependencies/parsers"
...
if parsers.IsValidPath("./requirements.txt") {
    // ...
}
```
...
line := parsers.PreprocessLine("dependency # comment")
// Returns: "dependency"

// Remove inline comments
clean := parsers.TrimComments("code // comment", "//")
// Returns: "code"
```
...
namespace, name := parsers.SplitNamespace("github.com/user/repo")
// Returns: ("github.com/user", "repo")

// Parse scoped packages
namespace, name := parsers.GetScopedPackage("@angular/core")
// Returns: ("@angular", "core")
```
...
```go
// Build a Package URL
purl := parsers.BuildPURL(
    "maven",                    // type
    "org.springframework",      // namespace
    "spring-core",              // name
    "5.3.0",                    // version
